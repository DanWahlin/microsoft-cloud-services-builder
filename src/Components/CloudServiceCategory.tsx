...
function CloudServiceCategory(props: { serviceCategory: IServiceCategory, filterCategories: (event: React.MouseEvent<HTMLDivElement, MouseEvent>, svcCat: IServiceCategory) => void }) {
    ...
    return (
        ...
        >
            <CloudBlock name={serviceCategory.category} />                
        </div>
    )
}
